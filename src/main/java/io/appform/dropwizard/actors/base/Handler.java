...
public class Handler<Message> extends DefaultConsumer {
    ...
    public Handler(final Channel channel,
        ...
        this.consumerMeta = new ConsumerMeta();
    }
    ...
    public void handleDelivery(String consumerTag, Envelope envelope,
        ...
        try {
            ...
            boolean success = retryStrategy.execute(() -> {
                consumerMeta.incrementActiveMessagesCount();
                return handle(message, messageProperties(envelope));
            });
        ...
        consumerMeta.decrementActiveMessagesCount();
    }
